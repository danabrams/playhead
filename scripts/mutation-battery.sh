...
T_41MU_REDRIVE="THE CONSEQUENCE — a non-completing terminal leaves resumable work, so the ad-scan re-drive can mint; the old \`complete\` left ZERO and blocked it"
