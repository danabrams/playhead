...
def main():
    ...
    print(f"If it sounds like host content, copy the episode-id + span to a 'reject' list")
    print(f"and run `python3 scripts/l2f-flag-false-promote.py {{eid}} {{start}}` (TBD).")
    print()
