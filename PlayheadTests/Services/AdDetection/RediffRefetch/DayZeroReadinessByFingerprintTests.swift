...
struct DayZeroReadinessByFingerprintTests {
    ...
    private func asset(id: String, episodeId: String, fingerprint: String) -> AnalysisAsset {
        ...
        a = AnalysisAsset(
            ...
            analysisVersion: a.analysisVersion, capabilitySnapshot: a.capabilitySnapshot,
            artifactClass: a.artifactClass, episodeDurationSec: a.episodeDurationSec,
            terminalReason: a.terminalReason, episodeTitle: a.episodeTitle,
            finalPassCoverageEndTime: a.finalPassCoverageEndTime
        )
        return a
    }
    ...
    func fetchByFingerprintIgnoresNewerStaleRows() async throws {
        ...
        try await store.insertAsset(asset(id: "row-sha1", episodeId: "ep", fingerprint: "SHA1"))
        try await store.insertAsset(asset(id: "row-sha2", episodeId: "ep", fingerprint: "SHA2"))
