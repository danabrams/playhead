...
- **`BASELINE IS FICTION` fires on a clean serialized run:** the 118 entries were recorded under the parallel regime and pass serialized, and `--accept-baseline` cannot clear it. Emptying `tests` is Dan's call (`artifacts/MEASUREMENTS.md` M7).
